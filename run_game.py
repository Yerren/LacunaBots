...
def main() -> None:
    ...
    players = [
        game_manager.create_player(player_colours[0], "Player 1", PlayerType.AI, bot_class=MaxDistanceGreedyBot()),
        game_manager.create_player(player_colours[1], "Player 2", PlayerType.AI, bot_class=RandomBot())
    ]
    # players = [
